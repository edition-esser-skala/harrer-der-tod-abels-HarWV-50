...
NeinAdamViola = {
  \relative c' {
    ...
    R1*58 %58
    r4 cis-!\fE a-! r
    r2 \tempoNeinAdamB g'16 d h g g' d h g %60
    g'4-! r r2
    \parOn g,4-\parenthesize-! g-! \parOff g-\parenthesize-! r
    r2 a4-! a-!
    c-\parenthesize-! r r8 r16 b-! b8-! r
    r2 r8 b-! b-! b-! %65
    b4~ b8 r16\fermata \tempoNeinAdamC \mvTr es'\f es4. es,8\p
    es es es es fes4\fermata r16 fes es des
    g4\ff^\tenuto r \tempoNeinAdamD r16 as,( b as) as-! as( b as)
    as4 r r2
    ...
    ges ges ges ges ges ges ges ges f8. \tempoNeinAdamH des16[-!\f des8.-! des16]-!
    des4~ des8 r r2
